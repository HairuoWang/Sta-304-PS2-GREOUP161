---
title: "Religion Affiliation status of Canadian and the Variables Affecting it hhhh"
...
This is a regression equation of logistic regression: @citemath
...
```{r}
#Build model with imported data using logistic regression
